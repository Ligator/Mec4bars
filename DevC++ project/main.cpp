...
struct type_m4bar{                                     // Entradas
     ...
     float LE;         // longitud extensión de barra2       -
     float ang1;///////// ángulo barra1
     float ang2;       // ángulo barra2
     float ang3;       // ángulo barra3
     float ang4;       // ángulo barra4
     float angE;       // ángulo extensión de barra2         -
     float ang2_show;//// ángulo interno barra2
     float ang3_show;  // ángulo interno barra3
     float x;//////////// posición inicial x barra1          -
     float y;          // posición inicial y barra1          -
     float z;          // posición inicial x barra1          -
     float ang1_ph;    // fase inicial barra1                -
     float angM;       // inclinación de mecanismo barra4    -
};
...
*/     
     ...
     else      printf("\n Te quedan %d días de prueba", (int)dif/(-60*60*24)); //tVencimiento >= tlocal
